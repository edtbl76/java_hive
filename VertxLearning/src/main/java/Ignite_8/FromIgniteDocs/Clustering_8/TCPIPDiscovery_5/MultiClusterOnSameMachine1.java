...
public class MultiClusterOnSameMachine1 extends AbstractVerticle {
    ...
    public void start() {
        ...
        ipFinder.setAddresses(Collections.singletonList("127.0.0.1:48500..48520"));
        ...
        igniteConfiguration
                ...
                .setIgniteInstanceName("TwoClustersOneSystemOne");
    ...
    private static void vertSetup() {
        ...
        Consumer<Vertx> runner = cv -> {
            try {
                cv.deployVerticle(MultiClusterOnSameMachine1.class.getName());
