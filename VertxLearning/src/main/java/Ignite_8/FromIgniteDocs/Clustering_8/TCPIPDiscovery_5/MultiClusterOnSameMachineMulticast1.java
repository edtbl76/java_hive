...
public class MultiClusterOnSameMachineMulticast1 extends AbstractVerticle {
    ...
    public void start() {
        ...
        ipFinder.setMulticastGroup("228.0.0.157");

        igniteConfiguration
                .setDiscoverySpi(discoverySpi)
                .setIgniteInstanceName("TwoClustersOneSystemMC1");
    ...
    private static void vertSetup() {
        ...
        Consumer<Vertx> runner = cv -> {
            try {
                cv.deployVerticle(MultiClusterOnSameMachineMulticast1.class.getName());
