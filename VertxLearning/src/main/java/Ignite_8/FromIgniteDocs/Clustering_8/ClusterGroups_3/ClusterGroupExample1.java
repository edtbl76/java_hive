...
public class ClusterGroupExample1 extends AbstractVerticle {
    ...
    public void start() {
        try (Ignite ignite = Ignition.start(igniteConfiguration)) {
            ...
            try (IgniteCache<String, String> igniteCache = ignite.getOrCreateCache(cacheConfiguration)) {
                System.out.println("I'm thing 1");
    ...
    private static void vertSetup() {
        ...
        Consumer<Vertx> runner = consumerVertx -> {
            try {
                consumerVertx.deployVerticle(ClusterGroupExample1.class.getName());
