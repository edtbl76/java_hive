...
class AccessingDataRestApplicationTests {
    ...
    public void shouldUpdateEntity() throws Exception {
        ...
        mockMvc.perform(put(Objects.requireNonNull(location)).content("{\"firstName\": \"Bilbo\", \"lastName\":\"Baggins\"}"))
    ...
    public void shouldPartiallyUpdateEntity() throws Exception {
        ...
        mockMvc.perform(patch(Objects.requireNonNull(location)).content("{\"firstName\": \"Bilbo Jr.\"}"))
                .andExpect(status().isNoContent());
    ...
    public void shouldDeleteEntity() throws Exception {
        ...
        mockMvc.perform(delete(Objects.requireNonNull(location))).andExpect(status().isNoContent());
